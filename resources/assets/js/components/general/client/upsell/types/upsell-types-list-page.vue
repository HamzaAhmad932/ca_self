    ...
    <div class="page-content" id="properties-listing-page">
        <div class="container">
            <div class="row" v-if="paginationResponse.meta !== undefined">
                <div class="col-md-12">
                    <div class="row"><div class="col-6"><a href="/client/v2/upsells" class="text-muted d-block text-md mb-1"><i class="fas fa-arrow-circle-left"></i>&nbsp;<span class="hidden-xs">Back to </span> Upsells list</a></div> </div>
                    <div class="page-header has-border-bottom mb-0">

                        <h1 class="page-title" style="display: inline;">Upsell Types <span class="text-muted" v-if="paginationResponse.meta.total"> - {{paginationResponse.meta.total}}</span>
                        </h1>
                        ...
                        <div class="booking-filter-stack">
                            ...
                            <button class="btn btn-sm btn-success mb-2 ml-1 sm-flex-auto" id="guide-books-add"
                                    onclick="window.location.href='upsell-types-add'">
                        ...
                        <div class="content-box">
                            ...
                            <div class="table-header d-none d-lg-block">
                                <div class="row">
                                    ...
                                    <div class="col-3 text-center"><a href="#0"> <span>Priority</span></a></div>
                                    <div class="col-3 text-center"><a href="#0"> <span>Upsells Attached</span></a></div>
                                                    ...
                                                    <div class="dropdown dropdown-sm">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right"
                                                            ...
                                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                                               ...
                                                               title="Edit">Edit</a>
                                                            <a class="dropdown-item" href="javascript:void(0)" @click="connectOrDisconnect(tac.id,index)"
                                                               title="Edit">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Upsell Type</h5>
                    ...
                    <div class="modal-body edit-form-outer-wrapper">
                        ...
                        <upsell-types-add-form :serve_id="serve_id" @updated="getLists(filters.page)"></upsell-types-add-form>
...
<script>
    ...
    import UpsellTypesAddForm from "./upsell-types-add-form";

    export default {
        components: {UpsellTypesAddForm},
        data() {
            return {
        ...
        computed: {
            ...mapState({
                ...
                filters: (state) => {
                    return state.general.upsellTypes.filters;
                },
                paginationResponse: (state) => {
                    return state.general.upsellTypes.paginationResponse;
                },
            }),
            //...mapActions(['getUpsellTypesList'])
        },
        mounted() {
        ...
        methods: {
            ...
            getLists(page = 1) {
                ...
                this.$store.dispatch('general/getUpsellTypesList');
            },
            ...
            connectOrDisconnect(id,index) {
                let self = this;
                let status = 0;
                let msg = 'Do You Really Want Delete ?';
                swal.fire({
                    title: msg,
                    type: "question",
                    showCancelButton: !0,
                    ...
                    if (e.value === true) {
                        if (await self.$store.dispatch('general/updateUpsellTypeStatus', payload)) {
                            self.$store.commit('general/UPDATE_UPSELL_TYPE_STATUS', {
                                index: index,
                                'updateWhat': 'status',
                                'updateWith': status
                            });
                        ...
                        //     self.$store.commit('UPDATE_UPSELL_TYPE_STATUS', {
                        //         index: index,
                        //         'updateWhat': 'required',
                        //         'updateWith': status
                        //     });
