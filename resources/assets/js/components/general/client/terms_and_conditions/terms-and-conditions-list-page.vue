            ...
            <div class="row" v-if="paginationResponse.meta !== undefined">
                <div class="col-md-12">
                    <div class="page-header has-border-bottom mb-0">
                        <h1 class="page-title" style="display: inline;">Terms & Conditions <span class="text-muted" v-if="paginationResponse.meta.total"> - {{paginationResponse.meta.total}}</span></h1>
                        ...
                        <div class="booking-filter-stack">
                            <div class="d-flex sm-flex-auto">
                                <select v-model="filters.recordsPerPage" @change="getTacLists" class="custom-select custom-select-sm mb-2 mr-1" id="inlineFormInputName3" ref="recordsPerPage">
                            ...
                            <button class="btn btn-sm btn-success mb-2 ml-1 sm-flex-auto" id="sync_properties_btn" onclick="window.location.href='terms-and-conditions-add'">
                        ...
                        <div class="content-box">
                                ...
                                <div class="filter-form">
                                    <div class="form-row align-items-end">
                                        ...
                                        <div class="form-group col-md-2 col-sm-5">
                                            ...
                                            <select class="custom-select custom-select-sm" id="filter-properties" v-model="filters.property_info_id" @change.prevent="getTacLists">
                                        ...
                                        <div class="form-group col-md-2 col-sm-5">
                                            ...
                                            <select class="custom-select custom-select-sm" id="filter-rentals"  v-model="filters.room_info_id" @change.prevent="getTacLists">
                            ...
                            <div class="table-header d-none d-lg-block">
                                <div class="row">
                                    ...
                                    <div class="col-3"><a href="#0"> <span>Required Status</span></a></div>
                                    <div class="col-1 pl-2"><a href="#0"> <span>Action</span></a></div>
                                </div>
                            </div>

                            <!-- Property Card-->
                            <div :class="'property-card  ' + (tac.status  ? 'property-connected' : 'property-disconnected')"  v-for="(tac, index) in paginationResponse.data" :key="tac.id">
                                <div class="card-pane">
                                    <div class="for-booking-list-page-only-outer t-b-padding-lg-10">
                                        <div class="row no-gutters for-booking-list-page-only-inner">
                                            ...
                                            <div class="col-3 col-style pl-4 pl-lg-0 text-center" style="padding: 0 10px;">
                                                <div class="checkbox-toggle checkbox-choice">
                                                    <input :id="'checkbox_status-'+tac.id" type="checkbox"  :name="'checkbox_status-'+tac.id" :checked="tac.status== 1" @change="connectOrDisconnect($event, tac.id, index)"/>
                                                    <label class="checkbox-label" :for="'checkbox_status-'+tac.id" data-on="ON" data-off="OFF">
                                                ...
                                                <span v-if="tac.status" data-toggle="tooltip" data-placement="top" title="Active For Attached Rentals" class="badge badge-success status-badge-align ml-2">
                                                <i class="fas fa-check-circle"></i>
                                                Active
                                            </span>
                                                <span v-else data-toggle="tooltip" data-placement="top" title="In-active For Attached Rentals" class="badge badge-warning status-badge-align ml-2">
                                                <i class="fas fa-exclamation-triangle"></i>
                                                In-active
                                            </span>
                                            </div>
                                            <div class="col-3 col-style pl-4 pl-lg-0 " style="padding: 0 10px;">
                                                <div class="checkbox-toggle checkbox-choice">
                                                    <input :id="'checkbox_required-'+tac.id" type="checkbox"  :name="'checkbox_required-'+tac.id" :checked="tac.required== 1" @change="updateRequiredStatus($event, tac.id, index)"/>
                                                    <label class="checkbox-label" :for="'checkbox_required-'+tac.id" data-on="ON" data-off="OFF">
                                                    <span class="toggle-track">
                                                        <span class="toggle-switch"></span>
                                                    </span>
                                                        <span class="toggle-title"></span>
                                                ...
                                                <span v-if="tac.required" data-toggle="tooltip" data-placement="top" title="Gust Should Be Agreed To These Terms and Conditions" class="badge badge-success status-badge-align ml-2">
                                                <i class="fas fa-check-circle"></i>
                                                Required
                                            </span>
                                                <span v-else data-toggle="tooltip" data-placement="top" title="Gust May Not Be Agreed To These Terms and Conditions" class="badge badge-warning status-badge-align ml-2">
                                                <i class="fas fa-exclamation-triangle"></i>
                                                Optional
                                            </span>
                                            </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="dropdown dropdown-sm">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="moreMenu">
                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#m_modal_edit" @click="editRecord(tac.id)" title="Edit Record">Edit</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div style="float: right !important;">
                        <pagination :data="paginationResponse" :limit="1" @pagination-change-page="getTacLists"></pagination>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade show" id="m_modal_edit" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content" >
                    ...
                    <div class="modal-body edit-form-outer-wrapper" id="model_body">
                        <!--Modal Pop-up Edit  Begin-->
                        <terms-and-conditions-add-form :serve_id="serve_id" @updated="getTacLists(filters.page)"></terms-and-conditions-add-form>
...
<script>
 ...
 import TermsAndConditionsAddForm from "./terms-and-conditions-add-form";
    export default {
        name: "TermsAndConditionsListPage",
        components: {TermsAndConditionsAddForm},
        data() {
            return {
        ...
        computed : {
            ...mapState({
                ...
                filters : (state)=>{
                    return state.general.tac.filters;
                },
                paginationResponse : (state)=>{

                    return state.general.tac.paginationResponse;
                },
            }),
            ...mapActions([
                'general/getTacList',
        ...
        methods: {
            ...
            getTacLists(page = 1) {
                ...
                this.$store.dispatch('general/getTacList');
            },
            ...
            connectOrDisconnect(event, id, index) {
                ...
                let msg = status  ?
                    'These Terms and Conditions are now Enabled for Guests' :
                    'Are you sure you want to disable these terms and conditions  for all rentals?';
                swal.fire({
                    title: msg,
                    type: "question",
                    showCancelButton: !0,
                    ...
                    if (e.value === true) {
                        if(await self.$store.dispatch('general/updateTacStatus', payload)){
                            self.$store.commit('general/TAC_STATUS_UPDATE', {
                                index:index,
                                'updateWhat' : 'status' ,
                                'updateWith':status
                            });
            ...
            updateRequiredStatus(event, id, index) {
                let self = this;
                let status = event.target.checked;
                let msg = status  ?
                    'Guest Should Be Agreed To These Terms and Conditions' :
                    'Are You Sure You Want To Make These Terms and Conditions Optional?';
                swal.fire({
                    title: msg,
                    type: "question",
                    showCancelButton: !0,
                    ...
                    let payload = {'id':id, 'updateWhat' : 'required' , 'updateWith':status};
                    if (e.value === true) {
                        if(await self.$store.dispatch('general/updateTacStatus', payload)){
                            self.$store.commit('general/TAC_STATUS_UPDATE', {
                                index:index,
