<template>
    <div>
<!--        <div class="tp-header">-->
<!--            <div class="small text-muted fw-500">Guest Pre-check-in</div>-->
<!--            <h4 class="mb-0">{{header.property_name}}</h4>-->
<!--        </div>-->
    ...
    export default {
        ...
        computed: {
            ...mapState({
                ...
                step_0: (state) => {
                    return state.pre_checkin.step_0;
                },
                header: (state) => {
            ...
            step_0: {
                ...
                handler(new_value, old_value) {
                    ...
                    if (new_value.is_completed) {
                        window.location.href = this.step_0.next_link;
                    }
                }
            }
        }
