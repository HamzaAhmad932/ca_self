<template>
    <div>
        ...
        <div class="gp-box gp-box-for-preCheckinSummaryStep">
            ...
            <div class="gp-box-steps gp-inset my-0 mx-auto">
...
<script>
    ...
    import StripeAddCard from "../../gatewayTerminals/StripeAddCard";
    import DummyAddCard from "../../gatewayTerminals/DummyAddCard";
    import GuestCreditCard from "../../client/reusables/GuestCreditCard";
    ...
    export default {
                    ...
                    if (this.summary.signature_pad) {
                        ...
                        try {
                            ...
                            if (Object.keys(this.summary.digital_signature).length === 0 && signaturePad.isEmpty) {
                                ...
                                self.saveDigitalSignature(dataSignature)
                                    .then(function (res) {
                                        self.completeThisStep();
                                    });
                            }
        ...
        computed: {
            ...mapState({
                ...
                summary: (state) => {
                    return state.general.pre_checkin.summary;
                },
                tac: (state) => {
                    return state.general.pre_checkin.tac;
                },
                meta: (state) => {
                    return state.general.pre_checkin.meta;
                },
                header: (state) => {
                    return state.general.pre_checkin.header;
                },
            })
        },
        watch: {
