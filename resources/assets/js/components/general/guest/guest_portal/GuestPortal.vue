    ...
    export default {
        ...
        methods: {
            ...mapMutations('general/', {
                ...
                'updateCardShow': 'UPDATE_CARD_SHOW',
                'updateContactFormShow': 'UPDATE_CONTACT_FORM_SHOW',
                'guideBookType': 'GUIDE_BOOK_TYPE'
            }),
            ...mapActions('general/', [
            ...
            editContactInfo() {
                this.updateContactFormShow(true);
            },
            cancelUpdateContactInfo() {
                this.updateContactFormShow(false);
            },
            upload(e) {
            ...
            getGuideBooks(guide_book_type) {
                this.guideBookType(guide_book_type);
            },
            triggerModal(){
        ...
        computed: {
            ...mapState({
                ...
                guest_portal: (state) => {
                    return state.general.guest_portal;
                },
                meta: (state) => {
                    return state.general.guest_portal.meta;
                },
                show_contact_info_form: (state) => {
                    return state.general.guest_portal.show_contact_info_form;
                },
                show_update_card_form: (state) => {
                    return state.general.guest_portal.show_update_card_form;
                },
                header: (state) => {
                    return state.general.guest_portal.header;
                },
                guide_book_types: (state) => {
                    return state.general.guest_portal.guide_book_types;
                },
                upsells: (state) => {
                    return state.general.guest_portal.upsells;
                },
                add_on_service: (state) => {
                    return state.general.pre_checkin.add_on_service;
                },
                in_cart_upsells: (state) => {
                    return state.general.pre_checkin.in_cart_upsells;
                },
                guest_images_status: (state) => {
                    return state.general.guest_portal.guest_images_status;
                }
            })
        },
        watch: {
