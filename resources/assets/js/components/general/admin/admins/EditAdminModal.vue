                ...
                <div class="modal-body">
                    <form class="m-form m-form--fit" method="post" id="memForm" >
                        ...
                        <div class="modal-footer text-right">
                            <button type="submit" id="submit" class="btn btn-primary" @click.prevent="saveAdmin()">Submit</button>
...
<script scoped>
    ...
    export default {
        ...
        methods: {
            ...
            getAdmin(){
                var self = this;
                axios.get('/admin/get-admin/' + self.user_id)
                    .then(function (response) {
                        if(response.status == 200){
                            self.admin_roles = response.data.data;
                        }
