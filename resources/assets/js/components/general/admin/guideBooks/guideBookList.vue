            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">
                        <i class="m-menu__link-icon flaticon-users"></i> Guide Books
                    </h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        <li class="m-nav__item">
                            <span class="m-nav__link-text">Guide Books List</span>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body" id="b-list">
                        ...
                        <div class="m-section__content">
                            <div class="row filter-fow">
                                <div class="form-group col-md-1">
                                    <label>&nbsp;</label>
                                    <select v-model="filters.recordsPerPage" @change="getAllGuideBooks" class="custom-select custom-select-sm mb-2 mr-1" id="inlineFormInputName3" ref="recordsPerPage">
                                ...
                                <div class="form-group col-md-2 col-sm-5">
                                    ...
                                    <select class="form-control form-control-sm" id="type" v-model="filters.type_id" @change.prevent="getAllGuideBooks">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="custom-select custom-select-sm" id="filter-properties" v-model="filters.property_info_id" @change.prevent="getAllGuideBooks">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="custom-select custom-select-sm" id="filter-rentals"  v-model="filters.room_info_id" @change.prevent="getAllGuideBooks">
                            ...
                            <div class="row heading-row">
                                ...
                                <div class="col-md-2"><strong>Publish Status</strong></div>
                            </div>
                                ...
                                <div class="panel panel-default" v-for="(tac, index) in paginationResponse.data">
                                    <div class="panel-heading">
                                        <div class="row" :class="index == 0 ? 'first-data-row' : 'data-row'">
                                            <div class="col-md-1">{{tac.id}}</div>
                                            <div class="col-md-2">
                                                <div class="single-line text-left">
                                                    <i :class="tac.icon"></i>
                                                </div>
                                            </div>
                                            <div class="col-md-2">{{tac.internal_name}}</div>
                                            <div class="col-md-3">{{tac.text_content}}</div>
                                            <div class="col-md-2">{{ tac.type }}</div>
                                            <div class="col-md-2">
                    ...
                    <!--end: table -->
                    <pagination :data="paginationResponse" :limit="1" @pagination-change-page="getAllGuideBooks" align="right"></pagination>
                </div>
            </div>
        </div>
        <!-- End Booking List-->
    ...
    export default {
        ...
        computed : {
            ...mapState({
                ...
                types: (state) => {
                    return state.adminGuideBook.types
                },
                filters: (state) => {
                    return state.adminGuideBook.filters;
                },
                paginationResponse: (state) => {
                    return state.adminGuideBook.paginationResponse;
                },
            }),
            // ...mapActions([
            //     'getAllGuideBooks', 'getAllGuideBookTypes'
            // ])
        },
        mounted() {
            this.$store.commit('SHOW_LOADER', null, {root: true});
            this.getAllGuideBookTypes();
            this.get_user_account();
            this.getAllGuideBooks(); // Fetch List
            this.get_properties();
        },
        methods: {
            /**
             ...
             */
            getAllGuideBookTypes() {
                this.$store.dispatch('getAllGuideBookTypes');
            },
            ...
            getAllGuideBooks(page = 1) {
                ...
                this.$store.dispatch('getAllGuideBooks');
            },
