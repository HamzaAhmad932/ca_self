        ...
        <div class="chat-content" id="chat-box-div"
            ...
            <div v-for="(m,index) in messages.messages" v-if="messages.messages !== undefined">
                ...
                <span class="text-center"
                      style="clear:both;color: #83909d;padding-left: 20%;" v-if="parseInt(messages.lastUnSeenMessageId) === parseInt(m.id) && (m.is_guest == 0)"> ------- Unread messages ------- </span>
                <div class="chat-message message-inbox" v-if="m.is_guest == 0">
                ...
                <div class="chat-message message-sent" v-else-if="m.is_guest == 1">
                    <div class="message-bulb">
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                if (typeof self.booking.booking_id !== "undefined") {
                    axios({
                        ...
                        .then((resp) => {
                            ...
                            if (typeof booking.guest_name !== undefined && booking.guest_name != null) {
                                self.guest.guest_name = booking.guest_name;
                            }

                            if (typeof booking.property_info !== undefined && booking.property_info != null) {
                                self.guest.property_name = booking.property_info.name;
                            }

                            if (typeof booking.room_info !== undefined && booking.room_info != null) {
                                self.guest.room_name = booking.room_info.name;
                            }

                            if (typeof booking.unit !== undefined && booking.unit != null && typeof booking.unit.unit_name !== undefined && booking.unit.unit_name != null) {
            ...
            sendMessage() {
                ...
                if (self.messages.messages[lastMsgId + 1] =
                    {
                        "id": lastMsgId + 1, "is_guest": 1, "alert_type": "chat", "message": self.message,
                        "message_read_by_guest": 1, "message_read_by_user": 0, "created_at": olderDate,
        ...
        computed: {
            ...mapState({
                booking: (state) => {
                    return state.booking.booking_id_action_chat;
                }
            })
        },
        watch: {
