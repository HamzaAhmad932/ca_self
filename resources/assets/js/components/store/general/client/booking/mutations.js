...
//         state.booking_detail = {...state.booking_detail, [index]: payload.data.booking_detail};
//         return state;
//     },
//
//     UPDATE_BOOKING_LIST(state, {payload, index}) {
//         $.each(state.booking_list.data, function (key, booking) {
//             if (booking.id == payload.data[0].id)
//                 state.booking_list.data[key] = payload.data[0];
//         });
