...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" >
    ...
    <body  class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-footer--push m-scroll-top--shown">
        <h1 class="page-title">Integration Guide - BookingAutomation</h1>
        <!-- begin:: Page -->
                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                    <div class="m-content">
                        ...
                        <div class="m-portlet m-portlet--full-height">
                            <a href="https://manage.bookingautomation.com/control2.php?pagetype=accountpassword" target="_blank" class="step-title" style="color: #1faca9; font-size: 1.5em;display: block;margin-bottom: 5px">
                                <strong>A:</strong> Click Settings -> Account Access
                            </a>
                            <div class="image-wrapper">
                                <img src="{{ asset('images/integration/bookingautomation/step_A.png') }}"/>
                            </div>
                            <br>
                            <hr>
                            <br>
                            ...
                            <div class="image-wrapper">
                                <img src="{{ asset('images/integration/bookingautomation/step_B.png') }}"/>
                            </div>
                            <br>
                            <hr>
                            <br>
                            ...
                            <div class="image-wrapper">
                                ...
                                <img src="{{ asset('images/integration/bookingautomation/step_C.png') }}"/>
                            </div>
                            <br>
                            <hr>
                            <br>
                            ...
                            <div class="image-wrapper">
                                <img src="{{ asset('images/integration/bookingautomation/step_D.png') }}"/>
                            </div>
                            <br>
                            <hr>
                            <br>
                            ...
                            <div class="image-wrapper">
                                ...
                                <br>
                                <img src="{{ asset('images/integration/bookingautomation/step_E.png') }}"/>
                            ...
                            <br>
                            <div class="image-wrapper">
                                <img src="{{ asset('images/integration/bookingautomation/step_F.png') }}"/>
                            </div>
                            <br>
                            <hr>
                            <br>
                            ...
                            <br>
                            <div class="image-wrapper">
                                <img src="{{ asset('images/integration/bookingautomation/CA_pms_integration_page.png') }}"/>
                            </div>
                            <br>
                            <br>
                        </div>
