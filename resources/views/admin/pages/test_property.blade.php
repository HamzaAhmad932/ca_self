...
@section('content')
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper" id="test_property">
        ...
        <div class="m-subheader ">
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">{{__('admin/leftnav.test_property')}}</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            ...
                            <span class="m-nav__link-text">{{__('admin/leftnav.test_property')}}</span>
                        ...
                        <form id="test-booking-form">
                            ...
                            <div class="row m--margin-top-20" style="border-bottom: 1px solid #ebedf2; margin-bottom: 3rem; padding-bottom: 3rem;">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select id="user_account_id" name="user_account_id" class="form-control" v-model="test_property.user_account_id" @change="getPropertiesByUserAccount">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select id="property_id" name="property_id" class="form-control" v-model="test_property.property_id">
                                        <option value="" selected disabled>Select Property</option>
                                        <option v-for="property in properties" :value="property.id">@{{ property.id +' -- '+property.name }}</option>
                                    </select>
                                </div>

                                <div class="col-md-2">
                                    <label for="property_submit">&nbsp;</label>
                                    <br>
                                    <button type="button" id="property_submit" name="submit" @click="getPropertyXmlJsonRequest" class="btn btn-primary btn-block">Search</button>
                                </div>
                            </div>
                        </form>
...
{{--                                    <p>@{{ request_response.json_response }}</p>--}}
...
@section('ajax_script')
    ...
    <script>
        ...
        var testProperty = new Vue({
            ...
            methods:{
                getPropertyXmlJsonRequest(){
                    var self = this;
                    if(this.test_property.user_account_id == '') {
                        alert("Please enter user account id");
                        return;
                    }
                    if(this.test_property.property_id == '') {
                        alert("Please enter property id");
                        return;
                    }

                    mApp.block("#test_property",{
                        overlayColor:"#000000",
                        type:"loader",
                        state:"success",
                        message:"Please wait..."
                    ...
                    axios.post('{{route("getPropertyXmlJsonRequest")}}', self.test_property)
                ...
                getPropertiesByUserAccount(){
                    var self = this;
                    axios.post('{{route("getPropertiesByUserAccount")}}', {user_account_id : self.test_property.user_account_id})
                        .then(function (response) {
                            // console.log(response.data);
                            if (response.status == 200) {
