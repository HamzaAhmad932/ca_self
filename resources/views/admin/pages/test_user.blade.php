...
@section('content')
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper" id="test_user">
        ...
        <div class="m-subheader ">
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">{{__('admin/leftnav.test_user')}}</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            ...
                            <span class="m-nav__link-text">{{__('admin/leftnav.test_user')}}</span>
            ...
            <div class="m-portlet">
                <div class="m-portlet__body">
                    ...
                    <div class="m-section__content">
                        ...
                        <form id="test-booking-form" class="form-inline">
                            {{ csrf_field() }}

                            <div class="form-group mb-2">
                                <label for="user_account_id" style="margin-right: 5rem;">User Account</label>
                            </div>
                            <div class="form-group mx-sm-3 mb-2">
                                <select id="user_account_id" name="user_account_id" class="form-control" v-model="test_user.user_account_id">
                            ...
                            <button type="button" id="user_submit" name="submit" @click="getUserXmlJsonRequest" class="btn btn-primary mb-2">Search</button>
                        </form>
                        <hr style="color: #ebedf2; margin-top: 3rem; margin-bottom: 3rem;">
...
@section('ajax_script')
    ...
    <script>
        ...
        var testUser = new Vue({
            ...
            methods:{
                getUserXmlJsonRequest(){
                    var self = this;
                    if(this.test_user.user_account_id == '') {
                        alert("Please enter user account id");
                        return;
                    }

                    mApp.block("#test_user",{
                        overlayColor:"#000000",
                        type:"loader",
                        state:"success",
                        message:"Please wait..."
                    ...
                    axios.post('{{route("getUserXmlJsonRequest")}}', self.test_user)
                ...
                getAllUsers(){
                    var self = this;
                    axios.get('{{route("getAllUserAccounts")}}', self.test_user)
                        .then(function (response) {
                            // console.log(response.data);
