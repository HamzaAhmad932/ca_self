...
return [
    ...
    \App\GuestData::class => [
        'variables' => [
            ...
            'email' => '{Guest_Email}',
            'phone' => '{Guest_Phone}',
            'country_code' => '{Guest_Phone_Country_Code}',
    ...
    \App\TransactionInit::class => [
        ...
        'relationships' => [
            \App\TransactionDetail::class => [
                'relationship_name' => 'transactions_detail',
                'results' => 'plural',
                'first_or_last' => 'last' //because we have multiple records
            ],
            \App\BookingInfo::class => [
            ...
            \App\RefundDetail::class => [
                'relationship_name' => 'refund_detail',
                'results' => 'plural',
                'first_or_last' => 'last' //because we have multiple records
            ],
            \App\CreditCardInfo::class => [
    ...
    */
    \App\CreditCardAuthorization::class => [
        ...
        'relationships' => [
            ...
            \App\AuthorizationDetails::class => [
                'relationship_name' => 'authorization_details',
                'results' => 'plural',
                'first_or_last' => 'last',
                'support_eager_loading' => true
            ]
