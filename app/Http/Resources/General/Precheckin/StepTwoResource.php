...
class StepTwoResource extends JsonResource
{
    ...
    {
        $meta = $this->getNextPageData(Config::get('db_const.pre_checkin.step_2'), $this->booking_id);
        ...
        return [
            ...
            'arriving_by' => !empty($this->arriving_by) ? $this->arriving_by : '',
            'plane_number' => $this->plane_number,
            'other' => $this->other_detail,
