...
class TodayAndTomorrowCheckinResource extends JsonResource
{
    use Dashboard;
    /**
    ...
    public function toArray($request)
    {
        ...
        $logo_available = $this->bookingSourceForm['logo'] ? 1 : 0;

        $channel_initial = "";
        $channel_name = "";
        if(!$logo_available)
        {
            $channel_name = $this->bookingSourceForm->name;
        ...
        return [
            ...
            'bs_img_url' => '/storage/uploads/booking_souce_logo/' . $this->bookingSourceForm->logo,
