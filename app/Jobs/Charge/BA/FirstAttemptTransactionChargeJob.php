...
class FirstAttemptTransactionChargeJob implements ShouldQueue
{
    ...
    {
        /**
         * @var $record ReadyToFirstAttemptTransaction
         */

        /* Get //BA|Beds24 Transaction Records to charge */
        $records = ReadyToFirstAttemptTransaction::whereIn('pms_form_id', [1, 6])->get();
