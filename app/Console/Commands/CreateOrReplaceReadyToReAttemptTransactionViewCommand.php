...
class CreateOrReplaceReadyToReAttemptTransactionViewCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'view:CreateOrReplaceReadyToReAttemptTransactionView';
    ...
    public function handle()
    {
        ...
        $this->line("<fg=yellow>Creating ready_to_re_attempt_transactions VIEW.....  \n");


        \DB::statement("
            CREATE OR REPLACE VIEW ready_to_re_attempt_transactions
            AS
            SELECT tr.*, 
            ...
            WHERE tr.final_tick = 0 and tr.next_attempt_time <=  NOW() and tr.attempt >= 1  
            ...
            and tr.payment_status = ". TransactionInit::PAYMENT_STATUS_REATTEMPT ." 
            order by tr.due_date ASC"
        );

        $this->line("<fg=green>Created ready_to_re_attempt_transactions VIEW Successfully.");
